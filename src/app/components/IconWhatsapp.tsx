...
export function IconWhatsapp() {
    ...
    return (
        <div className="relative z-50">
            {
                !openedChat &&
                <div className="fixed hidden bottom-[90px] md:bottom-[112px] right-5 md:right-10 md:flex w-[338px] gap-2 rounded-l-[20px] rounded-tr-[20px] border border-[#152323] bg-[#060d0d] px-4 py-3 shadow-emerald-300/10 shadow-[0px_4px_32px_0px] sm:right-10 sm:w-[330px]">
                    <div>
            ...
            <Link href={'https://api.whatsapp.com/send?phone=5531984372245&text=Olá%2C%20você%20pode%20me%20ajudar%3F'} target="_blank" onClick={handleClickWhatsapp}>
                <div className="fixed bottom-5 right-5 md:bottom-10 md:right-10 p-3 bg-emerald-400 rounded-2xl">
                    <FaWhatsapp size={32} />
                </div>
            </Link>
        </div>
