...
export function Slider() {
    ...
    return (
        ...
        >
            ...
            <SwiperSlide className='w-full lg:min-w-[800px]' style={{ display: 'flex', justifyContent: 'center' }}>
                <div className={`h-[400px] lg:w-[800px] px-4 ${isCurrent === 0 ? 'opacity-100' : 'opacity-10'}  transition-all  duration-300 ease-in-out`}>
                    <div className='lg:w-[800px] h-[400px] '>
                        <div className=' flex  md:flex-row justify-between lg:w-[800px] h-[400px] border border-white/10 rounded-2xl'>
                            <div>
                                <div className='flex-col w-[200px] md:w-[280px] h-full flex justify-between items-center bg-radial-[100%_60%_at_0%_0%] from-violet-500/70 from-0%  to-100% to-[#07090D] rounded-tl-2xl rounded-bl-2xl pb-10'>
                                    ...
                                    <div className=''>
                                        ...
                                        <button className='bg-white  items-center gap-2 hidden md:flex text-[#07090D] px-6 py-2 rounded-full font-semibold'>Case de Sucesso
                                            <Image src={Arrow} alt='' />
                                        </button>
                                    </div>
