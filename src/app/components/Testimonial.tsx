    ...
    return (
        <div>
            <div className='flex justify-center w-full gap-8 overflow-hidden'>
                ...
                <div>
                    <div className=' opacity-10 flex  justify-between w-[800px] h-[400px] border border-white/10 rounded-2xl'>
                        <div>
                            <div className='flex-col w-[280px] h-full flex justify-between items-center bg-radial-[100%_60%_at_0%_0%] from-sky-500/70 from-0%  to-100% to-[#07090D] rounded-tl-2xl rounded-bl-2xl pb-10'>
                                ...
                                <button className='bg-white text-[#07090D] px-6 py-2 rounded-full font-semibold'>Case de Sucesso</button>
                            </div>
                        </div>
